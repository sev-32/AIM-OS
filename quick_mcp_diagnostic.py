#!/usr/bin/env python3
"""
Quick MCP Diagnostic - Fast debugging for immediate issues
"""
...
def quick_diagnostic():
    """Run quick MCP diagnostic"""
    print("🔍 Quick MCP Diagnostic")
    print("=" * 40)
    ...
    if missing_vars:
        issues.append(f"⚠️ Missing environment variables: {', '.join(missing_vars)}")
    else:
